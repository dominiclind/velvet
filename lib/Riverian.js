...
class Riverian {
            ...
            return function * views (next) {
                this.render = function * render (view, locals) {
                    ...
                    locals.menu = function menu (name) {                        
                        ...
                        _.each(__adminMenu, function (items, menuName) {                            
                            html += '<ul>';
                            html += '<li class="menu-name">'+menuName+'</li>';
                            _.each(items, function (href, name) {
    ...
    registerAdminMenu (name, items) {
        __adminMenu[name] = items;
    }
    ...
    setupKoa() {
        ...
        this.koa.use(
            mount(
                '/admin/static',
                serve(path.join(this.root, '/lib/admin/dist'))
            )
        );
        // Use the bodyparser
