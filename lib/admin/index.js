...
module.exports = {
    ...
    views: function() {
        return {
            ...
            'admin/layouts/distraction-free': path.join(__dirname, 'views/layouts/distraction-free.swig'),
            ...
            'admin/partials/navbar-top': path.join(__dirname, 'views/partials/navbar-top.swig')
        }
    }
}
